        ...
        for ( s in c("1", "2048") ) {
            ...
            if ( nrow(data) > 0 ) {
                ...
                mplot <- ggplot(data=data) +
                         geom_col(aes(x=stripe_unit, y=bw/1024), width=32) +
                         ...
                         labs(y="Throughput (MiB)", title=paste0("Throughput vs CephFS stripe unit (", iotype, ", fsize:", s, "MiB)")) +
                ...
                ggsave(plot=mplot,
                       ...
                       height = 6,
                       dpi    = 600,
                       filename=paste0(paste("plot_bw_stripeunit_nt", nt, "os", os, iotype, s, sep="_"), ".pdf"))
            }
        }
    }
}
